...
public class PathNodeEntity extends Entity {
    ...
    public PathNodeEntity(EntityType type, World w) {
        super(type, w);
    }

    public PathNodeEntity(Vec3d pos, float pitch, float yaw, float roll, World w) {
        this(TYPE, w);
